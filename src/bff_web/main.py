...
settings = Config()
app_configs: dict[str, Any] = {"title": "BFF-Web EntregasDeLosAlpes"}
...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("eventos-orden", "entregasDeLosAlpes-bff", "public/default/eventos-orden", eventos=eventos))
    tasks.append(task1)
